...
class AlarmRepositoryTest {
    ...
    public void findAlarmByUserTest() {
        ...
        assertThat(alarmByUser1.get(0).getMedicationInfo().getUser().getUsername()).isEqualTo("홍길동");
        assertThat(alarmByUser2.get(0).getMedicationInfo().getUser().getUsername()).isEqualTo("김길동");
    }
