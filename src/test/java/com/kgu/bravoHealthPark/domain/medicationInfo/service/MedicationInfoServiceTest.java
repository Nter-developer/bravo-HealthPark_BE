...
class MedicationInfoServiceTest {
    ...
    public void updateInfoTest(){
        ...
        MedicationInfo medicationInfo = new MedicationInfo(saveUser, LocalDate.now(), medicationInfoForm1, Type.VitaminC);
        ...
        assertThat(saveMedicationInfo.getEntpName()).isEqualTo("아주제약");
